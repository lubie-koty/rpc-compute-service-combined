...
// 	protoc        v6.30.1
// source: protos/complex/service-complex.proto
...
func (x *UnaryRequest) Reset() {
	*x = UnaryRequest{}
	mi := &file_protos_complex_service_complex_proto_msgTypes[0]
...
func (*UnaryRequest) Descriptor() ([]byte, []int) {
	return file_protos_complex_service_complex_proto_rawDescGZIP(), []int{0}
}
...
func (x *BinaryRequest) Reset() {
	*x = BinaryRequest{}
	mi := &file_protos_complex_service_complex_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*BinaryRequest) Descriptor() ([]byte, []int) {
	return file_protos_complex_service_complex_proto_rawDescGZIP(), []int{1}
}
...
func (x *OperationResponse) Reset() {
	*x = OperationResponse{}
	mi := &file_protos_complex_service_complex_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OperationResponse) Descriptor() ([]byte, []int) {
	return file_protos_complex_service_complex_proto_rawDescGZIP(), []int{2}
}
...
var File_protos_complex_service_complex_proto protoreflect.FileDescriptor

const file_protos_complex_service_complex_proto_rawDesc = "" +
	"\n" +
	"$protos/complex/service-complex.proto\x12\acomplex\"&\n" +
	...
	"\x05Round\x12\x16.complex.BinaryRequest\x1a\x1a.complex.OperationResponse\"\x00BCZAgithub.com/lubie-koty/rpc-compute-service-combined/protos/complexb\x06proto3"

var (
	file_protos_complex_service_complex_proto_rawDescOnce sync.Once
	file_protos_complex_service_complex_proto_rawDescData []byte
)

func file_protos_complex_service_complex_proto_rawDescGZIP() []byte {
	file_protos_complex_service_complex_proto_rawDescOnce.Do(func() {
		file_protos_complex_service_complex_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_protos_complex_service_complex_proto_rawDesc), len(file_protos_complex_service_complex_proto_rawDesc)))
	})
	return file_protos_complex_service_complex_proto_rawDescData
}

var file_protos_complex_service_complex_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_protos_complex_service_complex_proto_goTypes = []any{
...
var file_protos_complex_service_complex_proto_depIdxs = []int32{
...
func init() { file_protos_complex_service_complex_proto_init() }
func file_protos_complex_service_complex_proto_init() {
	if File_protos_complex_service_complex_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_protos_complex_service_complex_proto_rawDesc), len(file_protos_complex_service_complex_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protos_complex_service_complex_proto_goTypes,
		DependencyIndexes: file_protos_complex_service_complex_proto_depIdxs,
		MessageInfos:      file_protos_complex_service_complex_proto_msgTypes,
	}.Build()
	File_protos_complex_service_complex_proto = out.File
	file_protos_complex_service_complex_proto_goTypes = nil
	file_protos_complex_service_complex_proto_depIdxs = nil
}
